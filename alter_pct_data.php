...
<html>
  ...
  <body>
    ...
    <form class="mt-2" action="./controll/validacao_alter_pct_data.php?id=<?php echo $id; ?>" method="post">
      
      <div class="form-group">
          <label for="data_atendimento">Nova Data de Nasciemnto</label>
          <input type="date" name ="alter_pct_data" class="form-control" id="id_alter_pct_data">
      </div>
